...
namespace DC_REST.Services
{
	public class NoteService : INoteService
	{
		...
		public NoteService(IRepository<Note> noteRepository, IMapper mapper, IValidator<NoteRequestTo> noteValidator, IRepository<Issue> issueRepository)
		{
		...
		public NoteResponseTo CreateNote(NoteRequestTo noteRequestDto)
		{
			...
			if (_issueRepository.GetById(noteRequestDto.Id) == null)
			{
				throw new ArgumentException("Invalid note data");
			}
